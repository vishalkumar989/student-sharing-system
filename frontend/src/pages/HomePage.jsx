...
const HomePage = () => {
    ...
    const fetchItems = async () => {
        ...
        try {
            const res = await axios.get('https://student-sharing-api.onrender.com/api/items');
            setItems(res.data);
        } catch (error) {
    ...
    const handleSearch = async (e) => {
        ...
        setLoadingItems(true);
        try {
            const res = await axios.get(`https://student-sharing-api.onrender.com/api/items/search?q=${searchTerm}`);
            setItems(res.data);
        } catch (error) {
